...
Comments: -
====================================================================== */
int8_t SI7021::readRegister(uint8_t * value)
{
  uint8_t error ;
...
Comments: 0 if okay
====================================================================== */
uint8_t SI7021::checkCRC(uint16_t data, uint8_t check)
{
...
====================================================================== */
int8_t SI7021::startConv(uint8_t datatype, uint8_t resolution)
{
  long data;
  uint16_t raw ;
  ...
  */
  ...
  // Temperature
    ...
    // save value
    temperature = (float)((int16_t) data)/100;
  }
...
Comments: -
====================================================================== */
int8_t SI7021::readValues(uint8_t resolution)
{
  int8_t error = 0;

  // start humidity conversion
  error |= startConv(SI7021_MEASURE_HUM, resolution);

  // start temperature conversion
  error |= startConv(SI7021_MEASURE_TEMP, resolution);
...
Comments: -
====================================================================== */
int8_t SI7021::setResolution(uint8_t res)
{
  uint8_t reg;
  uint8_t error;
...
Comments: -
====================================================================== */
boolean SI7021::begin(uint8_t resolution)
{
  uint8_t ret;

  // Set the resolution we want
  ret = setResolution(resolution);
  if ( ret == 0 ) {
    ret = true;
  } else {
